...
<head>
	...
	<meta name="description" content="buddyBonds web application.News page.Stay updated and alert with buddyBonds News.Get notified about ongoing activities from leading newspapers around the globe.Connect and share.Social media website to make buddies,chat,upload pictures,videos and expanding your business."/>
...
<nav class="navbar sticky-top" id="nav">
	<ul class="navbar-nav">
		<li class="nav-item">
			...
			<a href="" class="big_nav_active_link" data-toggle="tooltip" title="News"><i class="fas fa-newspaper nav_large_icons"></i>  <span class="nav_large_texts"><b>News</b></span><span class="sr-only">(current)</span></a>
		</li>
	</ul>
...
<div id="news_sec">
	<header><span class="hdr1 text-success">b</span><span class="hdr1 text-warning">u</span><span class="hdr1 text-danger">d</span><span class="hdr1 text-primary">d</span><span class="hdr1" style="color:#FF00FF">y</span><span class="hdr1" style="color:#00FA9A">B</span><span class="hdr1 text-warning">o</span><span class="hdr1" style="color:#C71585">n</span><span class="hdr1 text-danger">d</span><span class="hdr1" style="color:#4B0082">s </span><span id="hdr2" class="text-muted"><b> News</b></span></header>
	<div class="text-muted" id="hdr3">We ensure to give you the latest and absolutely real news from the leading newspapers all around the world on a single page.</div><hr>
	<div class="row padding_cls" id="nav_row">
		<div class="spc text-center col-lg-4" id="tech" data-toggle="tooltip" title="Tech News"><b>TECHNOLOGY</b></div>
		<div class="spc text-center col-lg-4" id="busi" data-toggle="tooltip" title="Business News"><b>BUSINESS</b></div>
		<div class="spc text-center col-lg-4" id="sprt" data-toggle="tooltip" title="Sports News"><b>SPORTS</b></div>
	</div>
	<div class="padding_cls" id="nav_row_sm">
		<button class="spc_sm btn btn-light" id="tech_sm"><a href="javascript:void(0)" class="small_style"><i class="fas fa-mobile-alt fa-2x"></i><br>Technology</a></button>
		<button class="spc_sm btn btn-light" id="busi_sm"><a href="javascript:void(0)" class="small_style"><i class="fas fa-money-bill-alt fa-2x"></i><br>Business</a></button>
		<button class="spc_sm btn btn-light" id="sprt_sm"><a href="javascript:void(0)" class="small_style"><i class="fas fa-trophy fa-2x"></i><br>Sports</a></button>
	</div>
	<div id="news_spnr"><img src="images/spnr.gif" id="news_spnr_img"></div>
	<div class="padding_cls" id="show">
	<?php 
		$url=file_get_contents("https://newsapi.org/v2/top-headlines?sources=the-times-of-india,the-hindu,the-guardian-uk,bbc-news,espn&apiKey=d526d1decd964bb8be209820fc4ec219");
