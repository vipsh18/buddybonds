...
<head>
	...
	<meta name="description" content="socialConnet web application.Settings page for user.Customize your homepage and post settings.Connect and share.Social media website to make buddies,chat,upload pictures,videos and expanding your business"/>
...
<div id="settings">
	<div id="shdr" class="text-danger"><b><i class="fa fa-wrench faa-wrench animated"></i> SETTINGS</b></div>
	<div id="set_menu">
		<div class="set_menu_opts">
			<a href="edit_profile.php" class="text-dark set_menu_opts_hdr" id="edit_pro"><b><i class="fas fa-edit"></i> Edit Your Profile</b></a><br>
			<span class="set_menu_opts_descp text-muted">This option lets you edit your profile.</span>
		</div>
		<div class="set_menu_opts">
			<a href="chng_password.php" class="text-dark set_menu_opts_hdr" id="chng_psw"><b><i class="fas fa-star"></i> Change Your Password</b></a><br>
			<span class="set_menu_opts_descp text-muted">This option lets you change your password.</span>
		</div>
		<div class="set_menu_opts">
			<div class="text-dark set_menu_opts_hdr"><b><i class="fas fa-user-circle"></i> Account Type</b><label class="switch" id="account_switch_label"><input type="checkbox" id="account_switch"><span class="slider round"></span></label>Open</div>
			<?php 
			    if($uiqrow['account_type']=="open") {
		        ?>
		        <script> $('#account_switch').prop('checked', true); </script>
		        <?php
		    } else if($uiqrow['account_type']="private") {
		        ?>
		        <script> $('#account_switch').prop('checked', false); </script>
		        <?php
		    }
			?>
			<span class="set_menu_opts_descp text-muted">This option lets you change your account type. Shifting to Open will convert your account from a private account in which only your buddies can view your posts and message you to an open account in which your posts are available to anyone for viewing and are available to be shown in the explore page.</span>
		</div>
	</div>
</div>
...
<script>
$(function() {
    $('#account_switch').change(function() {
	     $.ajax({
	        type:"POST",
	        url:"http://localhost/buddyBonds_backup/scripts/change_account_type.php",
	        success:function(result) {},
	        error:function(result) {
	            $('body').html("Could not complete request!");
	        }
	     });
	});
});
