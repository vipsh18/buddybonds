...
<head>
	...
	<script>
		if(window.matchMedia("(min-width:1101px) and (max-width:2500px)").matches) window.location="http://localhost/buddyBonds_backup/chat.php?un=<?php echo $un; ?>";
	</script>
	...
	<link rel="stylesheet" href="css/mobile_chat.css">
...
<div id="chat_div">
	<?php
		...
		echo '<div id="chat_div_row">';
			if($cibr->rowCount()>0) {
				if(file_exists($gbirw['buddypic'])) echo '<img src="'.$gbirw['buddypic'].'" class="rounded-circle bd_img">';
				else echo '<img src="images/def_buddypic.png" class="rounded-circle bd_img">';
			} else {
				echo '<img src="images/def_buddypic.png" class="rounded-circle bd_img">';
			}
			echo '<a href="profile.php?un='.$un.'" id="bd_un" class="text-success"><b>'.$un.'</b></a>';
			if($cibr->rowCount()>0) {
				$cibrw=$cibr->fetch(PDO::FETCH_ASSOC);
				//logout time
				$lt=$gbirw['logout_time'];
				echo '<span class="text-primary" id="bd_lt"></span>';
			}
			?>
			<span class="cdr_hdr_btns"><button class="btn btn-sm btn-light" id="attach_btn" data-toggle="tooltip" title="Attach A File"><i class="fas fa-paperclip"></i></button><button class="btn btn-sm btn-light" id="emoji_btn" data-toggle="popover" data-placement="right" data-html="true" data-title='<a href="javascript:void(0)" data-target="#emoji_carousel" data-slide-to="0" class="active emoji_carousel_slide_to">😃</a><a href="javascript:void(0)" data-target="#emoji_carousel" data-slide-to="1" class="emoji_carousel_slide_to">👋</a>' data-content='<div id="emoji_carousel" class="carousel slide" data-ride="carousel"><div class="carousel-inner"><div class="carousel-item active"><a href="javascript:void(0)" class="emojis" data-emoji="603">😃</a><a href="javascript:void(0)" class="emojis" data-emoji="604">😄</a><a href="javascript:void(0)" class="emojis" data-emoji="600">😀</a><a href="javascript:void(0)" class="emojis" data-emoji="601">😁</a><a href="javascript:void(0)" class="emojis" data-emoji="606">😆</a><a href="javascript:void(0)" class="emojis" data-emoji="605">😅</a><a href="javascript:void(0)" class="emojis" data-emoji="923">🤣</a><a href="javascript:void(0)" class="emojis" data-emoji="602">😂</a><a href="javascript:void(0)" class="emojis" data-emoji="642">🙂</a><a href="javascript:void(0)" class="emojis" data-emoji="643">🙃</a><a href="javascript:void(0)" class="emojis" data-emoji="609">😉</a><a href="javascript:void(0)" class="emojis" data-emoji="60A">😊</a><a href="javascript:void(0)" class="emojis" data-emoji="607">😇</a><a href="javascript:void(0)" class="emojis" data-emoji="60D">😍</a><a href="javascript:void(0)" class="emojis" data-emoji="618">😘</a><a href="javascript:void(0)" class="emojis" data-emoji="617">😗</a><a href="javascript:void(0)" class="emojis" data-emoji="61A">😚</a><a href="javascript:void(0)" class="emojis" data-emoji="619">😙</a><a href="javascript:void(0)" class="emojis" data-emoji="60B">😋</a><a href="javascript:void(0)" class="emojis" data-emoji="61B">😛</a><a href="javascript:void(0)" class="emojis" data-emoji="61C">😜</a><a href="javascript:void(0)" class="emojis" data-emoji="61D">😝</a><a href="javascript:void(0)" class="emojis" data-emoji="911">🤑</a><a href="javascript:void(0)" class="emojis" data-emoji="917">🤗</a><a href="javascript:void(0)" class="emojis" data-emoji="910">🤐</a><a href="javascript:void(0)" class="emojis" data-emoji="610">😐</a><a href="javascript:void(0)" class="emojis" data-emoji="611">😑</a><a href="javascript:void(0)" class="emojis" data-emoji="636">😶</a><a href="javascript:void(0)" class="emojis" data-emoji="60F">😏</a><a href="javascript:void(0)" class="emojis" data-emoji="644">🙄</a><a href="javascript:void(0)" class="emojis" data-emoji="62C">😬</a><a href="javascript:void(0)" class="emojis" data-emoji="60C">😌</a><a href="javascript:void(0)" class="emojis" data-emoji="62A">😪</a><a href="javascript:void(0)" class="emojis" data-emoji="634">😴</a><a href="javascript:void(0)" class="emojis" data-emoji="924">🤤</a><a href="javascript:void(0)" class="emojis" data-emoji="912">🤒</a><a href="javascript:void(0)" class="emojis" data-emoji="915">🤕</a><a href="javascript:void(0)" class="emojis" data-emoji="922">🤢</a><a href="javascript:void(0)" class="emojis" data-emoji="927">🤧</a><a href="javascript:void(0)" class="emojis" data-emoji="60E">😎</a><a href="javascript:void(0)" class="emojis" data-emoji="615">😕</a><a href="javascript:void(0)" class="emojis" data-emoji="641">☹</a><a href="javascript:void(0)" class="emojis" data-emoji="62E">😮</a><a href="javascript:void(0)" class="emojis" data-emoji="632">😲</a><a href="javascript:void(0)" class="emojis" data-emoji="633">😳</a><a href="javascript:void(0)" class="emojis" data-emoji="630">😰</a><a href="javascript:void(0)" class="emojis" data-emoji="62D">😭</a><a href="javascript:void(0)" class="emojis" data-emoji="631">😱</a><a href="javascript:void(0)" class="emojis" data-emoji="616">😖</a><a href="javascript:void(0)" class="emojis" data-emoji="623">😣</a><a href="javascript:void(0)" class="emojis" data-emoji="624">😤</a><a href="javascript:void(0)" class="emojis" data-emoji="621">😡</a><a href="javascript:void(0)" class="emojis" data-emoji="608">😈</a><a href="javascript:void(0)" class="emojis" data-emoji="480">💀</a><a href="javascript:void(0)" class="emojis" data-emoji="4A9">💩</a></div><div class="carousel-item"><a href="javascript:void(0)" class="emojis" data-emoji="648">🙈</a><a href="javascript:void(0)" class="emojis" data-emoji="649">🙉</a><a href="javascript:void(0)" class="emojis" data-emoji="64A">🙊</a><a href="javascript:void(0)" class="emojis" data-emoji="48B">💋</a><a href="javascript:void(0)" class="emojis"  data-emoji="498">💘</a><a href="javascript:void(0)" class="emojis" data-emoji="497">💗</a><a href="javascript:void(0)" class="emojis" data-emoji="495">💕</a><a href="javascript:void(0)" class="emojis" data-emoji="494">💔</a><a href="javascript:void(0)" class="emojis" data-emoji="5A4">🖤</a><a href="javascript:void(0)" class="emojis" data-emoji="4AF">💯</a><a href="javascript:void(0)" class="emojis" data-emoji="4A5">💥</a><a href="javascript:void(0)" class="emojis" data-emoji="4AB">💫</a><a href="javascript:void(0)" class="emojis" data-emoji="4A6">💦</a><a href="javascript:void(0)" class="emojis" data-emoji="4A8">💨</a><a href="javascript:void(0)" class="emojis" data-emoji="4A3">💣</a><a href="javascript:void(0)" class="emojis" data-emoji="44B">👋</a><a href="javascript:void(0)" class="emojis" data-emoji="91A">🤚</a><a href="javascript:void(0)" class="emojis" data-emoji="590">🖐</a><a href="javascript:void(0)" class="emojis" data-emoji="596">🖖</a><a href="javascript:void(0)" class="emojis" data-emoji="44C">👌</a><a href="javascript:void(0)" class="emojis" data-emoji="91E">🤞</a><a href="javascript:void(0)" class="emojis" data-emoji="919">🤙</a><a href="javascript:void(0)" class="emojis" data-emoji="448">👈</a><a href="javascript:void(0)" class="emojis" data-emoji="449">👉</a><a href="javascript:void(0)" class="emojis" data-emoji="446">👆</a><a href="javascript:void(0)" class="emojis" data-emoji="595">🖕</a><a href="javascript:void(0)" class="emojis" data-emoji="447">👇</a><a href="javascript:void(0)" class="emojis" data-emoji="44D">👍</a><a href="javascript:void(0)" class="emojis" data-emoji="44E">👎</a><a href="javascript:void(0)" class="emojis" data-emoji="44A">👊</a><a href="javascript:void(0)" class="emojis" data-emoji="44F">👏</a><a href="javascript:void(0)" class="emojis" data-emoji="64C">🙌</a><a href="javascript:void(0)" class="emojis" data-emoji="64F">🙏</a><a href="javascript:void(0)" class="emojis" data-emoji="485">💅</a><a href="javascript:void(0)" class="emojis" data-emoji="933">🤳</a><a href="javascript:void(0)" class="emojis" data-emoji="476">👶</a><a href="javascript:void(0)" class="emojis" data-emoji="9D2">🧒</a><a href="javascript:void(0)" class="emojis" data-emoji="467">👧</a><a href="javascript:void(0)" class="emojis" data-emoji="468">👨</a><a href="javascript:void(0)" class="emojis" data-emoji="469">👩</a><a href="javascript:void(0)" class="emojis" data-emoji="474">👴</a><a href="javascript:void(0)" class="emojis" data-emoji="475">👵</a><a href="javascript:void(0)" class="emojis" data-emoji="645">🙅</a><a href="javascript:void(0)" class="emojis" data-emoji="646">🙆</a><a href="javascript:void(0)" class="emojis" data-emoji="481">💁</a><a href="javascript:void(0)" class="emojis" data-emoji="64B">🙋</a><a href="javascript:void(0)" class="emojis" data-emoji="647">🙇</a><a href="javascript:void(0)" class="emojis" data-emoji="926">🤦</a><a href="javascript:void(0)" class="emojis" data-emoji="937">🤷</a><a href="javascript:void(0)" class="emojis" data-emoji="64E">👮</a><a href="javascript:void(0)" class="emojis" data-emoji="482">💂</a><a href="javascript:void(0)" class="emojis" data-emoji="477">👷</a><a href="javascript:void(0)" class="emojis" data-emoji="934">🤴</a><a href="javascript:void(0)" class="emojis" data-emoji="478">👸</a><a href="javascript:void(0)" class="emojis" data-emoji="473">👳</a><a href="javascript:void(0)" class="emojis" data-emoji="935">🤵</a><a href="javascript:void(0)" class="emojis" data-emoji="47C">👼</a><a href="javascript:void(0)" class="emojis" data-emoji="385">🎅</a><a href="javascript:void(0)" class="emojis" data-emoji="48F">💏</a><a href="javascript:void(0)" class="emojis" data-emoji="936">🤶</a></div></div></div>'>😃</button></span><br><form method="POST" enctype="multipart/form-data" id="attach_file_form"><input type="file" name="attachment" id="attachment"><button class="btn btn-sm btn-info" type="submit" id="attach_send" title="Sending larger images can take larger time."><b>Send</b></button><img src="images/spnr.gif" class="img-responsive" id="attaching_file_spnr"><input type="hidden" id="send_to" value="<?php echo $un; ?>" name="send_to"><span id="attach_form_error"></span></form><button class="btn btn-sm text-secondary" id="close_atf" title="Close"><i class="fas fa-times-circle"></i></button>
			<?php
		echo '</div>';
		...
		echo '<div id="chats_area">';
		    echo '<div class="text-center" id="chat_loader"><img src="images/spnr.gif" alt="Loading Previous Chats" width="45" height="45"></div>';
		    if($mcqr->rowCount() > 0) {
		        while($mcqrow=$mcqr->fetch(PDO::FETCH_ASSOC)) { 
			        if($mcqrow['bud_id1'] == $upk) {
        				...
        				echo '</span></div></div></div>';//op_msgs is other person msgs
			        }
		        }
		...
		echo '</div>';
		if($cibr->rowCount()>0) {
		    echo '<nav class="navbar fixed-bottom" id="chat_bottom_navbar">
		              <form class="form-inline">
		                    <textarea class="form-control" placeholder="Type Your Message" id="new_msg_cont" required minlength="1" maxlength="1000" spellcheck="false"></textarea>
		                    <button class="btn btn-success btn-sm" id="send_msg_btn" disabled><img src="images/send_white.png" id="send_msg_btn_img"></button>
		              </form>
		          </nav>';
			echo '<audio id="message_sent_tone" src="sounds/msg_sent.mp3" preload="auto"></audio>';
		} else {
			echo '<div class="fixed-bottom"><input type="text" class="form-control msg text-center" value="You need to buddies with '.$un.' to message them." id="new_msg_cont" disabled></div>';
			?>
...
<script src="js/mobile_chat.js"></script>
<script>
var mc = "<?php echo $mc; ?>";
var id = "<?php echo $id; ?>";
var ms = 30;
$(function() {
	...
	$('#new_msg_cont').keyup(function(e) {
		...
		if($(this).height() >= 100) $('#new_msg_cont').css('overflow-y','scroll');
		else $(this).css('overflow-y','hidden');
	});
	$('#send_msg_btn').click(function() {
	    if($('#new_msg_cont').val().length >= 1) {
	        send_msg();
			$('#new_msg_cont').height(35);
			$('#new_msg_cont').val("");
	    } 
	});
...
if(window.Worker) var chatWorker = new Worker("js/chat_worker.js");
check_new_messages();
